...
void mqtt_setup() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientID.c_str(), MQTT_USER, MQTT_KEY)) {
      ...
      Serial.print("Failed to connect MQTT with state ");
...
void callback_mqtt(char *topic, byte *payload, unsigned int length) {
  ...
  if (strcmp(topic, MQTT_TOPIC[4]) != 0 && strcmp(topic, MQTT_TOPIC[5]) != 0 && strcmp(topic, MQTT_TOPIC[6]) != 0) {
    return;
  }
...
void Task_read_sensor(void *pvParameters) {
  while (1) {
    ...
    //Serial.printf("Temp: %.2f°C, Hum: %.2f%%\n", temp, hum);
    send_mqtt(MQTT_TOPIC[0], temp, "sensor", "00000000-0000-0000-0000-000000000001", "temperature");
    send_mqtt(MQTT_TOPIC[1], hum, "sensor", "00000000-0000-0000-0000-000000000002", "humidity");
    send_mqtt(MQTT_TOPIC[2], (float)light, "sensor", "00000000-0000-0000-0000-000000000003", "light");
    send_mqtt(MQTT_TOPIC[3], (float)distance, "sensor", "00000000-0000-0000-0000-000000000004", "water-level");
...
void send_mqtt(const char *topic, float value, const char *type, const char *id, const char *dataname) {
...
void loop() {
  ...
  if (IrReceiver.decode()) {
    ...
    if (IrReceiver.decodedIRData.decodedRawData == Button1) {
      ...
      send_mqtt(MQTT_TOPIC[4], fan_enable, "device", "00000000-0000-0000-0000-000000000005", "fan");
      ...
      send_mqtt(MQTT_TOPIC[5], led_enable, "device", "00000000-0000-0000-0000-000000000006", "led");
      ...
      send_mqtt(MQTT_TOPIC[6], pump_enable, "device", "00000000-0000-0000-0000-000000000007", "pump");
    }
    IrReceiver.resume();
  }
}